CREATE DATABASE IF NOT EXISTS T13_INSURANCE_COMPANY;
USE T13_INSURANCE_COMPANY;
-- drop database T13_INSURANCE_COMPANY;

-- Table 1
CREATE TABLE IF NOT EXISTS T13_INCIDENT
(
...
CREATE UNIQUE INDEX XPKINCIDENT_17 ON T13_INCIDENT (Incident_Id ASC);
-- Table 2
-- cust_id = 50201...50220
CREATE TABLE IF NOT EXISTS T13_CUSTOMER
(
...
CREATE UNIQUE INDEX XPKCUSTOMER_1 ON T13_CUSTOMER (Cust_Id ASC);



-- Table 4
CREATE TABLE IF NOT EXISTS T13_INSURANCE_COMPANY
(
...
CONSTRAINT XPKT13_INSURANCE_COMPANY_15 PRIMARY KEY
(Company_Name)
);
CREATE UNIQUE INDEX XPKT13_INSURANCE_COMPANY_15 ON T13_INSURANCE_COMPANY
(Company_Name ASC);
-- Table 5
CREATE TABLE IF NOT EXISTS T13_DEPARTMENT
(
...
REFERENCES T13_INSURANCE_COMPANY (Company_Name) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKDEPARTMENT ON T13_DEPARTMENT
(Department_Name ASC,Department_ID ASC,Company_Name ASC);

-- Table 6

CREATE TABLE T13_VEHICLE_SERVICE
(
...
Company_Name) REFERENCES T13_DEPARTMENT (Department_Name,
Department_ID, Company_Name) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKVEHICLE_SERVICE ON T13_VEHICLE_SERVICE
...
Vehicle_Engine_Number VARCHAR(15) NULL ,
...
CONSTRAINT R_92 FOREIGN KEY (Cust_Id) REFERENCES T13_CUSTOMER 
(Cust_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKVEHICLE_6 ON T13_VEHICLE (Vehicle_Id ASC,Cust_Id ASC);

-- Table 3
CREATE TABLE IF NOT EXISTS T13_INCIDENT_REPORT
(
...
(Incident_Report_Id,Incident_Id,Vehicle_Id), 
CONSTRAINT R_83 FOREIGN KEY (Incident_Id) REFERENCES T13_INCIDENT (Incident_Id) ON DELETE CASCADE ON UPDATE CASCADE, 
CONSTRAINT R_86 FOREIGN KEY (Vehicle_Id) REFERENCES T13_VEHICLE (Vehicle_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKINCIDENT_REPORT_18 ON T13_INCIDENT_REPORT (Incident_Report_Id ASC,Incident_Id ASC,Vehicle_Id ASC);
...
(Premium_Payment_Id,Vehicle_Id),
CONSTRAINT R_85 FOREIGN KEY (Vehicle_Id) REFERENCES T13_VEHICLE
(Vehicle_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKPREMIUM_PAYMENT_5 ON
T13_PREMIUM_PAYMENT
(Premium_Payment_Id ASC,Vehicle_Id ASC);

-- TABLE 9
CREATE TABLE IF NOT EXISTS T13_RECEIPT
(
Receipt_Id VARCHAR(20) NOT NULL ,
Time DATE NOT NULL ,
...
Premium_Payment_Id VARCHAR(20) NOT NULL ,
Vehicle_Id VARCHAR(20) NOT NULL ,
CONSTRAINT XPKRECEIPT_21 PRIMARY KEY (Receipt_Id,Premium_Payment_Id,Vehicle_Id),
CONSTRAINT R_84 FOREIGN KEY (Premium_Payment_Id, Vehicle_Id)
REFERENCES T13_PREMIUM_PAYMENT (Premium_Payment_Id, Vehicle_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKRECEIPT_21 ON T13_RECEIPT (Receipt_Id ASC,Premium_Payment_Id ASC,Vehicle_Id ASC);

-- TABLE 10 
CREATE TABLE IF NOT EXISTS T13_APPLICATION
(
...
CONSTRAINT R_93 FOREIGN KEY (Cust_Id) REFERENCES T13_CUSTOMER
(Cust_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKAPPLICATION_2 ON T13_APPLICATION
(Application_Id ASC,Cust_Id ASC);

-- TABLE 11

CREATE TABLE IF NOT EXISTS T13_INSURANCE_POLICY
(
...
CONSTRAINT R_95 FOREIGN KEY (Application_Id, Cust_Id) REFERENCES T13_APPLICATION (Application_Id, Cust_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKINSURANCE_POLICY_4 ON T13_INSURANCE_POLICY
...
REFERENCES T13_INSURANCE_POLICY (Agreement_id, Application_Id, Cust_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- TABLE 13
CREATE TABLE IF NOT EXISTS T13_MEMBERSHIP
(
...
CONSTRAINT R_91 FOREIGN KEY (Cust_Id) REFERENCES T13_CUSTOMER
(Cust_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKMEMBERSHIP_12 ON T13_MEMBERSHIP
(Membership_Id ASC,Cust_Id ASC);

-- TABLE 14
CREATE TABLE IF NOT EXISTS T13_QUOTE
(
...
T13_APPLICATION (Application_Id, Cust_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKQUOTE_3 ON T13_QUOTE
(Quote_Id ASC,Application_Id ASC,Cust_Id ASC);

-- TABLE 15
CREATE TABLE IF NOT EXISTS T13_STAFF
(
...
T13_INSURANCE_COMPANY (Company_Name) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKSTAFF_9 ON T13_STAFF (Staff_Id ASC,Company_Name ASC);
...
CREATE UNIQUE INDEX XPKNOK_14 ON T13_NOK (Nok_Id ASC,Agreement_id ASC,Application_Id ASC);

-- TABLE 17
CREATE TABLE IF NOT EXISTS T13_PRODUCT 
( 
...
CONSTRAINT R_107 FOREIGN KEY (Company_Name) REFERENCES T13_INSURANCE_COMPANY (Company_Name) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKPRODUCT_20 ON T13_PRODUCT (Product_Number ASC,Company_Name ASC);

-- TABLE 18
CREATE TABLE IF NOT EXISTS T13_OFFICE
(
...
CONSTRAINT R_104 FOREIGN KEY (Department_Name,Department_ID,Company_Name) REFERENCES T13_DEPARTMENT (Department_Name,Department_ID,Company_Name) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKOFFICE_11 ON T13_OFFICE (Office_Name ASC,Department_Name ASC,Company_Name ASC);

-- TABLE 19 
CREATE TABLE IF NOT EXISTS T13_COVERAGE 
( 
...
CREATE UNIQUE INDEX XPKCOVERAGE_19 ON T13_COVERAGE
(Coverage_Id ASC,Company_Name ASC);

-- TABLE 20

CREATE TABLE IF NOT EXISTS T13_INSURANCE_POLICY_COVERAGE 
( 
Agreement_id VARCHAR(20) NOT NULL , 
Application_Id VARCHAR(20) NOT NULL ,
Cust_Id VARCHAR(20) NOT NULL , 
...
REFERENCES T13_COVERAGE (Coverage_Id, Company_Name) ON DELETE CASCADE ON UPDATE CASCADE
); 
CREATE UNIQUE INDEX XPKINSURANCE_POLICY_4_COVERAGE ON 
T13_INSURANCE_POLICY_COVERAGE 
(Agreement_id ASC,Application_Id ASC,Cust_Id ASC,Coverage_Id 
ASC,Company_Name ASC);

-- TABLE 21
CREATE TABLE IF NOT EXISTS T13_CLAIM 
(
...
CONSTRAINT R_88 FOREIGN KEY (Cust_Id) REFERENCES T13_CUSTOMER
(Cust_Id) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT R_89 FOREIGN KEY (Incident_Id) REFERENCES T13_INCIDENT(Incident_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKCLAIM_7 ON T13_CLAIM
(Claim_Id ASC,Cust_Id ASC);

-- TABLE 22
CREATE TABLE IF NOT EXISTS T13_CLAIM_SETTLEMENT
(
...
CONSTRAINT R_90 FOREIGN KEY (Claim_Id, Cust_Id) REFERENCES T13_CLAIM
(Claim_Id, Cust_Id) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT R_103 FOREIGN KEY (Vehicle_Id) REFERENCES T13_VEHICLE
(Vehicle_Id) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT R_106 FOREIGN KEY (Coverage_Id) REFERENCES T13_COVERAGE
(Coverage_Id) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX XPKCLAIM_SETTLEMENT_8 ON
T13_CLAIM_SETTLEMENT
